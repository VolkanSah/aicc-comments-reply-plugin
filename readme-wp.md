# WPWM OpenAI (ChatGPT) Comments Reply
...
1. Upload the plugin files to the `/wp-content/plugins/wpwm-openai-comments-reply` directory, or install the plugin through the WordPress plugins screen directly.
